...
export const ProjectSection = () => {
  return (
    <div id="projects" className="min-h-screen w-full flex flex-col justify-center items-center p-4 sm:p-8">
      <h1 className="text-3xl sm:text-4xl mb-8 sm:mb-11 tracking-[.05em]">Projects</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 px-10 w-full max-w-7xl">
        {projects.map((item, index) => (
          <div key={index} className="rounded-lg p-4 shadow-xl bg-white/5 ring-1 ring-white/20 backdrop-blur-xl">
